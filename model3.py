...
def train_bayes_model():
    ...
    randomized_data = message_spam.sample(frac=1, random_state=32)
    ...
    with open('model_3_parameters.pkl', 'wb') as f:
        pickle.dump((p_spam, p_ham, vocabulary, parameters_spam, parameters_ham), f)

def classify3(message):
    # Load parameters and models
    with open('model_3_parameters.pkl', 'rb') as f:
