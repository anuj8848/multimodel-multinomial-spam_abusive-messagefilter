...
def train_bayes_model():
    ...
    randomized_data = message_spam.sample(frac=1, random_state=53)
    ...
    with open('model_5_parameters.pkl', 'wb') as f:
        pickle.dump((p_spam, p_ham, vocabulary, parameters_spam, parameters_ham), f)

def classify5(message):
    # Load parameters and models
    with open('model_5_parameters.pkl', 'rb') as f:
